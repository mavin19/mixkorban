...
<body>
    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav col-md justify-content-center">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-7">
                <img class="img-responsive" src="panorama.jpg" alt="Chania" width="500" height="355">
            </div>
            <div class="col-md-5">
                <img class="img-responsive mb-2" src="chair.jpg" alt="Chania" width="300" height="150">
                <img class="img-responsive mt-5" src="cocktail.jpg" alt="Chania" width="300" height="150">
            </div>
        </div> 
    </div>
